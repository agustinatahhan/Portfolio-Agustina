        ...
        <div data-aos="flip-up" className="row row-cols-1 row-cols-md-2 g-4">
            ...
            <NavLink to={sportiverseLink}>
              <div className="card">
                ...
                <div className="card-body">
                  <h5 className="card-title">Sportiverse</h5>
                  <p className="card-text">{t("projects.sportiverse_card")}</p>
                </div>
              </div>
            </NavLink>
          </div>
          ...
          <div className="col">
            <NavLink to={m4lifeLink}>
              <div className="card">
                <img src={m4life} className="card-img-top" alt="m4life" />
                <div className="card-body">
                  <h5 className="card-title">M4Life</h5>
                  <p className="card-text">{t("projects.m4life_card")}</p>
                </div>
              </div>
            </NavLink>
          </div>
          <div className="col">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">{t("projects.todo_card")}</p>
              </div>
            </div>
          </div>
        </div>
